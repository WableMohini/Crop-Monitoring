...
filepath = "E:/Plant-Leaf-Disease-Prediction/Plant-Leaf-Disease-Prediction/model.h5"
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread("E:/Plant-Leaf-Disease-Prediction/Plant-Leaf-Disease-Prediction/Dataset/test/Tomato___Septoria_leaf_spot (1).JPG")
